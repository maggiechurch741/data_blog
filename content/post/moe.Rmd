...
I don't know the extent to which voters are mislead by an article like this, and I don't know the effect that misleading has. But the bottom line is: let's all be data literate around election time, and remember what the margin of error is!
