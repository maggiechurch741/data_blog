...
3. using online polls
    ...
    * con: [inaccurate??](https://www.nytimes.com/2019/07/02/upshot/online-polls-analyzing-reliability.html) Beware of opt-in online polls...
...
I don't know the extent to which voters are mislead by an article like this, and I don't know the extent to which polls effect voting behavior. Well, I do know that there can be a [bandwagon effect](http://researchdmr.com/Why_Are_Polls_Self_Fulfilling_Prophecies) that makes poll results self-fulfilling prophecies. Anyways, the bottom line is: let's all be data literate around election time, and remember what the margin of error means!
