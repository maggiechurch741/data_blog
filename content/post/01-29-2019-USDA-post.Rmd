...
setwd("~/Documents/Coding/data_blog/content/post")
```
...
```{r}
dairy <- read_excel("dairy_consumption.xlsx",
                 skip = 10, 
                 col_names = FALSE) %>%
...
One of Lisa's suggestions was to use side-by-side plots. This doesn't really offer any more information, but it does keep the reader from makes those subconscious false assumptions due to  dual axes. 
